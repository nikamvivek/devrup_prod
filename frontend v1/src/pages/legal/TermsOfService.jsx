...
This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name https://www.devrup.in/ ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').

The Platform is owned by SHEETAL HANUMAN POPHALE, a company incorporated under the Companies Act, 1956 with its registered office at 404, Chandrabhaga Niwas Pune Lagad Colony sinhagad road pune  MAHARASHTRA PUNE 411041mbhaji Nagar, Maharashtra, 431005 (hereinafter referred to as ‘Platform Owner’, 'we', 'us', 'our')..
