...
//           <p className="mt-4 text-indigo-600 font-medium">Loading your addresses...</p>
//         </div>
//       </div>
//     );
//   }
  
//   console.log("Rendering AddressBook with addresses:", addresses);
...
//                   className="inline-flex items-center px-4 py-2 border border-transparent rounded-full shadow-sm text-sm font-medium text-white bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 transition-all duration-200 hover:shadow-md"
//                 >
...
//                   type="button"
//                   onClick={handleShowAddForm}
//                   className="inline-flex items-center px-5 py-2.5 border border-transparent shadow-sm text-sm font-medium rounded-full text-white bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 transition-all duration-200 hover:shadow-md"
//                 >
//                   <Plus size={16} className="mr-2" />
//                   Add Address
//                 </button>
