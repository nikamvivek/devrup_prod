...
// import { User, MapPin, ShoppingBag, CreditCard, Heart, LogOut, Edit, Key, Shield, Bell, Settings, ChevronRight } from 'lucide-react';
...
//                   <Link
//                     to="/profile/edit"
//                     className="inline-flex items-center px-4 py-2 border border-transparent rounded-full shadow-sm text-sm font-medium text-white bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all duration-300"
//                   >
...
//         {/* Navigation menu grid with animations */}
//         <motion.div 
//           variants={container}
//           initial="hidden"
//           animate="show"
...
//               <p className="text-sm mt-1">We're working on bringing you a detailed activity log</p>
//             </div>
//           </div>
//         </motion.div> */}
//       </div>
